...
static const _GKV2Status_type_support_symbol_names_t _GKV2Status_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gkv2_motor_bridge, msg, GKV2Status)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gkv2_motor_bridge, msg, GKV2Status)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gkv2_motor_bridge, msg, GKV2Status)() {
  return &::gkv2_motor_bridge::msg::rosidl_typesupport_c::GKV2Status_message_type_support_handle;
}
